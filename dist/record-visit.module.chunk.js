...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_treatmenttypes_service__ = __webpack_require__("../../../../../src/app/product/services/treatmenttypes.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_treatmentCategories__ = __webpack_require__("../../../../../src/app/product/services/treatmentCategories.ts");
...
var RecordVisitDetailComponent = (function () {
    function RecordVisitDetailComponent(http, treatmentTypesService, treatmentCategoriesService) {
        this.http = http;
        this.treatmentTypesService = treatmentTypesService;
        this.treatmentCategoriesService = treatmentCategoriesService;
    ...
    RecordVisitDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.treatmentTypesService.get(null, '/all').subscribe(function (response) {
    ...
    RecordVisitDetailComponent.prototype.category = function (item) {
        ...
        this.treatmentCategoriesService.get(null, "/" + item.id).subscribe(function (response) {
            _this.subcategories = [];
    ...
    RecordVisitDetailComponent.prototype.delete = function (i) {
        this.visitDetails.splice(i, 1);
    };
    RecordVisitDetailComponent.prototype.setFinalPrice = function (i) {
    ...
    RecordVisitDetailComponent.prototype.addPrice = function (i, price, discount, final) {
...
RecordVisitDetailComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_5__angular_http__["Http"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__angular_http__["Http"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_6__services_treatmenttypes_service__["a" /* TreatmentTypesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_treatmenttypes_service__["a" /* TreatmentTypesService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_7__services_treatmentCategories__["a" /* TreatmentCategoriesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__services_treatmentCategories__["a" /* TreatmentCategoriesService */]) === "function" && _c || Object])
