...
var PatientDetailsComponent = (function () {
    function PatientDetailsComponent(patientService) {
    ...
    PatientDetailsComponent.prototype.savePatientDetails = function () {
        ...
        this.patientService.create(this.patientData, null, '/save').subscribe(function (response) { return console.log("response on save patient is", response); });
    };
...
PatientDetailsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_6__services_patient_service__["a" /* PatientService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_patient_service__["a" /* PatientService */]) === "function" && _a || Object])
...
var PendingAmountPatientGrid = (function () {
    function PendingAmountPatientGrid() {
    }
